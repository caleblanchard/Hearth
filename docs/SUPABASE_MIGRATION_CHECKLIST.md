...
- [x] Create `src/lib/test-utils/supabase-mock.ts`
- [x] Create `src/lib/test-utils/supabase-auth-mock.ts`
- [x] Create example test using Supabase mocks
- [x] Validate mocks work correctly (18/18 tests passing)
- [x] Document test patterns (see src/lib/test-utils/README.md) in README
...
- [x] Create `src/lib/database.types.ts` (generated types)
...
- [x] Update kiosk integration tests
  - [x] `tests/integration/api/kiosk/session.test.ts` (18/18 passing)
  - [x] `tests/integration/api/kiosk/settings.test.ts` (10/10 passing)
- [x] All kiosk tests passing (28/28)
- [ ] Update `src/app/kiosk/page.tsx` if needed
...
- [x] Remove legacy database test mocks
...
- Keep legacy mock bridge only while tests still rely on dbMock
