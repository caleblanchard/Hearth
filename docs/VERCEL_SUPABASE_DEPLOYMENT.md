...
5. **Redirect URLs**: Add these (update after Vercel deployment):
   ...
   - `https://your-app.vercel.src/app/auth/callback` (add after deployment)
...
3. Add to **Redirect URLs**:
   - `https://hearth-xyz123.vercel.src/app/auth/callback`
...
3. Format: `https://your-app.vercel.src/app/auth/callback`
