# RecipeAutocomplete Component - Implementation Guide
    ...
    <div className="relative">
      <div className="relative">
        <input
          ...
          autoFocus={autoFocus}
          className={`w-full px-3 py-2 pl-10 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-ember-500 focus:border-transparent ${className}`}
        />
...
- ✅ Recipe thumbnails
- ✅ Category and dietary tag badges
...
- Follows existing Hearth design system
- Ember color theme for focus states
- Responsive and mobile-friendly

## Testing Considerations

When writing component tests:
1. Test debounce behavior
2. Test keyboard navigation
3. Test recipe selection
4. Test custom text entry
5. Test click outside
6. Test loading states
7. Test empty results
8. Test highlight matching

## Next Steps

After implementing this component:
1. Create AddToMealModal using RecipeAutocomplete
2. Update MealPlanner to use RecipeAutocomplete
3. Add to Recipe detail page for "Add to Meal" flow
