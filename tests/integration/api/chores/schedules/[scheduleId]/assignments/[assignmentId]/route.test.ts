...
describe('/api/chores/schedules/[scheduleId]/assignments/[assignmentId]', () => {
  ...
  describe('DELETE', () => {
    ...
    it('should return 404 if assignment not found', async () => {
      ...
      dbMock.choreAssignment.findUnique.mockResolvedValue(null)
    ...
    it('should soft delete assignment successfully', async () => {
      ...
      dbMock.choreAssignment.findUnique.mockResolvedValue(getMockAssignment(session) as any)
      dbMock.choreAssignment.update.mockResolvedValue({
        ...getMockAssignment(session),
        isActive: false,
      } as any)
      ...
      expect(dbMock.choreAssignment.update).toHaveBeenCalledWith({
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.choreAssignment.findUnique.mockResolvedValue(getMockAssignment(session) as any)
      dbMock.choreAssignment.update.mockRejectedValue(new Error('Database error'))
