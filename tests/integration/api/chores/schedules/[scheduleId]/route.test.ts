...
describe('/api/chores/schedules/[scheduleId]', () => {
  ...
  describe('PATCH', () => {
    ...
    it('should return 404 if schedule not found', async () => {
      ...
      dbMock.choreSchedule.findUnique.mockResolvedValue(null)
    ...
    it('should update schedule successfully', async () => {
      ...
      dbMock.choreSchedule.findUnique.mockResolvedValue(getMockSchedule(session) as any)
      dbMock.choreSchedule.update.mockResolvedValue(getMockUpdatedSchedule(session) as any)
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.choreSchedule.findUnique.mockResolvedValue(getMockSchedule(session) as any)
      dbMock.choreSchedule.update.mockRejectedValue(new Error('Database error'))
