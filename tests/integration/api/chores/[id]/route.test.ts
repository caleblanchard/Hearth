...
describe('/api/chores/[id]', () => {
  ...
  describe('GET', () => {
    ...
    it('should return 404 if chore not found', async () => {
      ...
      dbMock.choreDefinition.findUnique.mockResolvedValue(null)
    ...
    it('should return 403 if chore belongs to different family', async () => {
      ...
      dbMock.choreDefinition.findUnique.mockResolvedValue({
        ...mockChore,
    ...
    it('should return chore details for parent', async () => {
      ...
      dbMock.choreDefinition.findUnique.mockResolvedValue(mockChoreWithFamily as any)
      ...
      expect(dbMock.choreDefinition.findUnique).toHaveBeenCalledWith({
        where: { id: choreId },
        include: {
          schedules: {
            include: {
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.choreDefinition.findUnique.mockRejectedValue(new Error('Database error'))
  ...
  describe('PATCH', () => {
    ...
    it('should update chore successfully', async () => {
      ...
      dbMock.choreDefinition.update.mockResolvedValue(mockUpdatedChoreWithSchedules as any)
