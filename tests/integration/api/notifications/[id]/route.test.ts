...
describe('/api/notifications/[id]', () => {
  ...
  describe('PATCH', () => {
    ...
    it('should mark notification as read', async () => {
      ...
      dbMock.notification.findUnique.mockResolvedValue(mockNotification as any)
      dbMock.notification.update.mockResolvedValue(mockUpdatedNotification as any)
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.notification.findUnique.mockResolvedValue(mockNotification as any)
      dbMock.notification.update.mockRejectedValue(new Error('Database error'))
  ...
  describe('DELETE', () => {
    ...
    it('should delete notification successfully', async () => {
      ...
      dbMock.notification.findUnique.mockResolvedValue(mockNotification as any)
      dbMock.notification.delete.mockResolvedValue(mockNotification as any)
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.notification.findUnique.mockResolvedValue(mockNotification as any)
      dbMock.notification.delete.mockRejectedValue(new Error('Database error'))
