...
describe('GET /api/routines', () => {
  ...
  it('should return empty array if no routines exist', async () => {
    ...
    dbMock.routine.findMany.mockResolvedValue([]);
  ...
  it('should return all family routines for parent', async () => {
    ...
    dbMock.routine.findMany.mockResolvedValue(mockRoutines as any);
...
describe('POST /api/routines', () => {
  ...
  it('should create routine with basic fields', async () => {
    ...
    dbMock.routine.create.mockResolvedValue(mockRoutine as any);
