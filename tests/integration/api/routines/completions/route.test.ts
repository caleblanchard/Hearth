...
describe('GET /api/routines/completions', () => {
  ...
  it('should return all family completions for parent', async () => {
    ...
    dbMock.routineCompletion.findMany.mockResolvedValue(mockCompletions as any);
  ...
  it('should return only own completions for child', async () => {
    ...
    expect(dbMock.routineCompletion.findMany).toHaveBeenCalledWith(
  ...
  it('should support pagination with limit and offset', async () => {
    ...
    dbMock.routineCompletion.findMany.mockResolvedValue([]);
    dbMock.routineCompletion.count.mockResolvedValue(50);
  ...
  it('should default to limit 50 if not specified', async () => {
    ...
    dbMock.routineCompletion.findMany.mockResolvedValue([]);
    dbMock.routineCompletion.count.mockResolvedValue(100);
  ...
  it('should order completions by most recent first', async () => {
    ...
    dbMock.routineCompletion.findMany.mockResolvedValue([]);
    dbMock.routineCompletion.count.mockResolvedValue(0);
