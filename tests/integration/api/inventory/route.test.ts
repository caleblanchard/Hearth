...
describe('/api/inventory', () => {
  ...
  describe('GET /api/inventory', () => {
    ...
    it('should return all inventory items for family', async () => {
      ...
      dbMock.inventoryItem.findMany.mockResolvedValue(mockItems as any);
    ...
    it('should return empty array when no items exist', async () => {
      dbMock.inventoryItem.findMany.mockResolvedValue([]);
    ...
    it('should allow children to view inventory items', async () => {
      dbMock.inventoryItem.findMany.mockResolvedValue([mockInventoryItem] as any);
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.inventoryItem.findMany.mockRejectedValue(new Error('Database error'));
  ...
  describe('POST /api/inventory', () => {
    ...
    it('should create inventory item with minimal data', async () => {
      ...
      dbMock.inventoryItem.create.mockResolvedValue(minimalItem as any);
      ...
      expect(dbMock.inventoryItem.create).toHaveBeenCalledWith({
        data: {
          familyId: 'family-test-123',
          name: 'Milk',
          category: 'FOOD_FRIDGE',
    ...
    it('should create inventory item with full data', async () => {
      ...
      dbMock.inventoryItem.create.mockResolvedValue(fullItem as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.inventoryItem.create.mockRejectedValue(new Error('Database error'));
