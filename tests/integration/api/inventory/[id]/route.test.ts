...
describe('/api/inventory/[id]', () => {
  ...
  describe('GET /api/inventory/[id]', () => {
    ...
    it('should return 404 if item not found', async () => {
      dbMock.inventoryItem.findUnique.mockResolvedValue(null);
    ...
    it('should return 403 if item belongs to different family', async () => {
      ...
      dbMock.inventoryItem.findUnique.mockResolvedValue(otherFamilyItem as any);
    ...
    it('should return inventory item by id', async () => {
      dbMock.inventoryItem.findUnique.mockResolvedValue(mockInventoryItem as any);
      ...
      expect(dbMock.inventoryItem.findUnique).toHaveBeenCalledWith({
        where: { id: 'item-1' },
      });
    });
  ...
  describe('PATCH /api/inventory/[id]', () => {
    ...
    it('should update inventory item fields', async () => {
      ...
      dbMock.inventoryItem.update.mockResolvedValue(updatedItem as any);
      ...
      expect(dbMock.inventoryItem.update).toHaveBeenCalledWith({
        where: { id: 'item-1' },
        data: {
          currentQuantity: 3,
          notes: 'Updated notes',
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.inventoryItem.findUnique.mockResolvedValue(mockInventoryItem as any);
      dbMock.inventoryItem.update.mockRejectedValue(new Error('Database error'));
  ...
  describe('DELETE /api/inventory/[id]', () => {
    ...
    it('should delete inventory item successfully', async () => {
      dbMock.inventoryItem.findUnique.mockResolvedValue(mockInventoryItem as any);
      dbMock.inventoryItem.delete.mockResolvedValue(mockInventoryItem as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
      ...
      expect(dbMock.inventoryItem.delete).toHaveBeenCalledWith({
        where: { id: 'item-1' },
      });
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.inventoryItem.findUnique.mockResolvedValue(mockInventoryItem as any);
      dbMock.inventoryItem.delete.mockRejectedValue(new Error('Database error'));
