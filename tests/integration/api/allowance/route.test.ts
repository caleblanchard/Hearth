...
describe('/api/allowance', () => {
  ...
  describe('GET', () => {
    ...
    it('should return allowance schedules for authenticated user', async () => {
      ...
      dbMock.allowanceSchedule.findMany.mockResolvedValue(mockSchedules as any)
    ...
    it('should only return schedules from user family', async () => {
      ...
      dbMock.allowanceSchedule.findMany.mockResolvedValue([])
    ...
    it('should handle database errors', async () => {
      dbMock.allowanceSchedule.findMany.mockRejectedValue(new Error('Database error'))
  ...
  describe('POST', () => {
    ...
    it('should prevent duplicate active schedules for same member', async () => {
      ...
      dbMock.allowanceSchedule.findFirst.mockResolvedValue({
    ...
    it('should create weekly allowance schedule successfully', async () => {
      ...
      dbMock.allowanceSchedule.findFirst.mockResolvedValue(null)
      ...
      dbMock.allowanceSchedule.create.mockResolvedValue(mockSchedule as any)
    ...
    it('should handle optional startDate and endDate', async () => {
      ...
      dbMock.allowanceSchedule.findFirst.mockResolvedValue(null)
      dbMock.allowanceSchedule.create.mockResolvedValue({} as any)
    ...
    it('should handle database errors', async () => {
      ...
      dbMock.allowanceSchedule.findFirst.mockResolvedValue(null)
      dbMock.allowanceSchedule.create.mockRejectedValue(new Error('Database error'))
