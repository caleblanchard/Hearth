...
describe('GET /api/rules/executions', () => {
  ...
  it('should return all executions for family', async () => {
    dbMock.ruleExecution.findMany.mockResolvedValue(mockExecutions as any);
    dbMock.ruleExecution.count.mockResolvedValue(2);
  ...
  it('should support pagination', async () => {
    dbMock.ruleExecution.findMany.mockResolvedValue([mockExecutions[0]] as any);
    dbMock.ruleExecution.count.mockResolvedValue(2);
  ...
  it('should filter by ruleId', async () => {
    dbMock.ruleExecution.findMany.mockResolvedValue([mockExecutions[0]] as any);
    dbMock.ruleExecution.count.mockResolvedValue(1);
  ...
  it('should enforce maximum limit of 100', async () => {
    dbMock.ruleExecution.findMany.mockResolvedValue([] as any);
    dbMock.ruleExecution.count.mockResolvedValue(0);
  ...
  it('should return 500 on database error', async () => {
    dbMock.ruleExecution.findMany.mockRejectedValue(new Error('Database error'));
