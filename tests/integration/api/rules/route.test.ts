...
describe('GET /api/rules', () => {
  ...
  it('should return empty array if no rules exist', async () => {
    ...
    dbMock.automationRule.count.mockResolvedValue(0);
  ...
  it('should return all family rules for parent', async () => {
    ...
    dbMock.automationRule.findMany.mockResolvedValue(mockRules as any);
    dbMock.automationRule.count.mockResolvedValue(1);
  ...
  it('should cap limit at maximum value', async () => {
    ...
    const call = dbMock.automationRule.findMany.mock.calls[0]?.[0];
...
describe('POST /api/rules', () => {
  ...
  it('should trim whitespace from name', async () => {
    ...
    dbMock.automationRule.create.mockResolvedValue(mockRule as any);
    ...
    expect(dbMock.automationRule.create).toHaveBeenCalledWith(
      expect.objectContaining({
  ...
  it('should create rule with conditions', async () => {
    ...
    expect(dbMock.automationRule.create).toHaveBeenCalled();
  });
