...
describe('GET /api/rules/[id]', () => {
  ...
  it('should return 404 if rule not found', async () => {
    dbMock.automationRule.findUnique.mockResolvedValue(null);
  ...
  it('should return 403 if rule belongs to different family', async () => {
    dbMock.automationRule.findUnique.mockResolvedValue({
      ...mockRule,
  ...
  it('should return rule details with execution history', async () => {
    dbMock.automationRule.findUnique.mockResolvedValue(mockRule as any);
    ...
    dbMock.ruleExecution.count.mockResolvedValue(5);
  ...
  it('should filter execution history by success status', async () => {
    dbMock.automationRule.findUnique.mockResolvedValue(mockRule as any);
    dbMock.ruleExecution.findMany.mockResolvedValue([]);
    dbMock.ruleExecution.count.mockResolvedValue(3);
  ...
  it('should include execution statistics', async () => {
    ...
    // Mock all dbMock.ruleExecution.count calls in sequence
    ...
    dbMock.ruleExecution.findFirst.mockResolvedValue({
...
describe('PATCH /api/rules/[id]', () => {
  ...
  it('should return 404 if rule not found', async () => {
    (dbMock.automationRule.findUnique as jest.Mock).mockResolvedValue(null);
  ...
  it('should return 403 if rule belongs to different family', async () => {
    (dbMock.automationRule.findUnique as jest.Mock).mockResolvedValue({
      ...mockRule,
      familyId: 'other-family',
    });
  ...
  it('should update rule name', async () => {
    ...
    (dbMock.automationRule.update as jest.Mock).mockResolvedValue({
      ...mockRule,
  ...
  it('should create audit log when updating rule', async () => {
    ...
    (dbMock.auditLog.create as jest.Mock).mockResolvedValue({});
...
describe('DELETE /api/rules/[id]', () => {
  ...
  it('should delete rule successfully', async () => {
    (dbMock.automationRule.findUnique as jest.Mock).mockResolvedValue(mockRule);
    (dbMock.automationRule.delete as jest.Mock).mockResolvedValue(mockRule);
    ...
    expect(response.status).toBe(200);
    expect(data.success).toBe(true);
    expect(dbMock.automationRule.delete).toHaveBeenCalledWith({
      where: { id: 'rule-1' },
    });
  });
  ...
  it('should return 500 on database error', async () => {
    (dbMock.automationRule.findUnique as jest.Mock).mockResolvedValue(mockRule);
    (dbMock.automationRule.delete as jest.Mock).mockRejectedValue(
