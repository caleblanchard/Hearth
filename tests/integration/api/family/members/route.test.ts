...
describe('/api/family/members', () => {
  ...
  describe('POST', () => {
    ...
    it('should create parent with hashed password', async () => {
      ...
      dbMock.familyMember.findUnique.mockResolvedValue(null) // Email not in use
      dbMock.familyMember.create.mockResolvedValue(mockNewMember as any)
    ...
    it('should create child with hashed PIN', async () => {
      ...
      dbMock.screenTimeSettings.create.mockResolvedValue({} as any)
      dbMock.screenTimeBalance.create.mockResolvedValue({} as any)
      ...
      expect(dbMock.screenTimeSettings.create).toHaveBeenCalled()
      expect(dbMock.screenTimeBalance.create).toHaveBeenCalled()
    })
