...
describe('/api/family/members/[id]', () => {
  ...
  describe('PATCH', () => {
    ...
    it('should return 400 if email already in use by another member', async () => {
      ...
      dbMock.familyMember.findUnique
    ...
    it('should update member name', async () => {
      ...
      dbMock.familyMember.update.mockResolvedValue({
        ...mockMember,
        name: 'Updated Name',
      } as any)
    ...
    it('should update parent password with hashing', async () => {
      ...
      dbMock.familyMember.findUnique.mockResolvedValue(parentMember as any)
      dbMock.familyMember.update.mockResolvedValue({
        ...parentMember,
  ...
  describe('DELETE', () => {
    ...
    it('should return 400 if trying to delete last parent', async () => {
      ...
      dbMock.familyMember.findUnique.mockResolvedValue(parentMember as any)
      dbMock.familyMember.count.mockResolvedValue(1) // Only one parent
    ...
    it('should deactivate parent if not last parent', async () => {
      ...
      dbMock.familyMember.findUnique.mockResolvedValue(parentMember as any)
      dbMock.familyMember.count.mockResolvedValue(2) // Two parents
      dbMock.familyMember.update.mockResolvedValue({
        ...parentMember,
        isActive: false,
      } as any)
