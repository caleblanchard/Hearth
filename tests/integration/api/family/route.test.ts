...
describe('/api/family', () => {
  ...
  describe('GET', () => {
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.family.findUnique.mockRejectedValue(new Error('Database error'))
  ...
  describe('PATCH', () => {
    ...
    it('should update family settings successfully', async () => {
      ...
      dbMock.family.update.mockResolvedValue(mockUpdatedFamily as any)
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.family.update.mockRejectedValue(new Error('Database error'))
