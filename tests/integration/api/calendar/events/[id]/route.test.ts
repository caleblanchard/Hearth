...
describe('/api/calendar/events/[id]', () => {
  ...
  describe('PATCH', () => {
    ...
    it('should return 404 if event not found', async () => {
      ...
      dbMock.calendarEvent.findUnique.mockResolvedValue(null)
  ...
  describe('DELETE', () => {
    ...
    it('should delete event successfully', async () => {
      ...
      dbMock.calendarEvent.findUnique.mockResolvedValue(mockEvent as any)
      dbMock.calendarEvent.delete.mockResolvedValue(mockEvent as any)
      ...
      expect(dbMock.calendarEvent.delete).toHaveBeenCalledWith({
        where: { id: eventId },
      })
    })
  })
