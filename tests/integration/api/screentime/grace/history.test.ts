...
describe('GET /api/screentime/grace/history', () => {
  ...
  it('should return history for current user', async () => {
    ...
    dbMock.gracePeriodLog.findMany.mockResolvedValue(logs as any);
  ...
  it('should allow parents to view child history', async () => {
    ...
    dbMock.gracePeriodLog.findMany.mockResolvedValue(logs as any);
    dbMock.gracePeriodLog.count.mockResolvedValue(1);
  ...
  it('should support pagination', async () => {
    ...
    dbMock.gracePeriodLog.findMany.mockResolvedValue(logs as any);
    dbMock.gracePeriodLog.count.mockResolvedValue(10);
