...
describe('/api/screentime/history', () => {
  ...
  describe('GET', () => {
    ...
    it('should return own history for child', async () => {
      ...
      dbMock.screenTimeTransaction.count.mockResolvedValue(1)
    ...
    it('should allow parent to view child history', async () => {
      ...
      dbMock.screenTimeTransaction.count.mockResolvedValue(0)
    ...
    it('should support pagination', async () => {
      ...
      dbMock.screenTimeTransaction.findMany.mockResolvedValue([])
      dbMock.screenTimeTransaction.count.mockResolvedValue(100)
