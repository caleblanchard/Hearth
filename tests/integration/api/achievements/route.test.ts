...
describe('/api/achievements', () => {
  ...
  describe('GET', () => {
    ...
    it('should return achievements for authenticated user', async () => {
      ...
      dbMock.achievement.findMany.mockResolvedValue(mockAchievements as any)
      dbMock.userAchievement.findMany.mockResolvedValue(mockUserAchievements as any)
      dbMock.streak.findMany.mockResolvedValue([])
      ...
      expect(dbMock.achievement.findMany).toHaveBeenCalledWith({
        where: { isActive: true },
    ...
    it('should calculate progress for CHORES category', async () => {
      ...
      dbMock.streak.findMany.mockResolvedValue([])
      dbMock.choreInstance.count.mockResolvedValue(5) // 5 chores completed
      dbMock.creditBalance.findUnique.mockResolvedValue({
        lifetimeEarned: 0,
      } as any)
    ...
    it('should calculate progress for STREAKS category', async () => {
      ...
      dbMock.achievement.findMany.mockResolvedValue(mockAchievements as any)
      dbMock.userAchievement.findMany.mockResolvedValue([])
      dbMock.streak.findMany.mockResolvedValue(mockStreaks as any)
      dbMock.choreInstance.count.mockResolvedValue(0)
      dbMock.creditBalance.findUnique.mockResolvedValue({
        lifetimeEarned: 0,
      } as any)
    ...
    it('should allow parent to view child achievements', async () => {
      ...
      dbMock.achievement.findMany.mockResolvedValue([])
      dbMock.userAchievement.findMany.mockResolvedValue([])
      dbMock.streak.findMany.mockResolvedValue([])
      dbMock.choreInstance.count.mockResolvedValue(0)
    ...
    it('should cap percentage at 100', async () => {
      ...
      dbMock.userAchievement.findMany.mockResolvedValue([])
      dbMock.streak.findMany.mockResolvedValue([])
      dbMock.choreInstance.count.mockResolvedValue(15) // More than requirement
      dbMock.creditBalance.findUnique.mockResolvedValue(null)
