...
describe('PATCH /api/communication/[id]', () => {
  ...
  it('should allow author to update content', async () => {
    ...
    dbMock.communicationPost.findUnique.mockResolvedValue(existingPost as any);
    dbMock.communicationPost.update.mockResolvedValue(updatedPost as any);
  ...
  it('should create audit log on update', async () => {
    ...
    dbMock.communicationPost.findUnique.mockResolvedValue(existingPost as any);
    dbMock.communicationPost.update.mockResolvedValue({ ...existingPost, content: 'Updated' } as any);
    dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  it('should create pin audit log when pinning', async () => {
    ...
    dbMock.communicationPost.findUnique.mockResolvedValue(existingPost as any);
    dbMock.communicationPost.update.mockResolvedValue({ ...existingPost, isPinned: true } as any);
    dbMock.auditLog.create.mockResolvedValue({} as any);
...
describe('DELETE /api/communication/[id]', () => {
  ...
  it('should allow author to delete own post', async () => {
    ...
    dbMock.communicationPost.findUnique.mockResolvedValue(existingPost as any);
    dbMock.communicationPost.delete.mockResolvedValue(existingPost as any);
    dbMock.auditLog.create.mockResolvedValue({} as any);
    ...
    expect(response.status).toBe(200);
    expect(dbMock.communicationPost.delete).toHaveBeenCalledWith({
      where: { id: 'post-123' },
    });
  });
