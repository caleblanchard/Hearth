...
describe('/api/financial/transactions', () => {
  ...
  it('should return transactions for authenticated user', async () => {
    ...
    dbMock.creditTransaction.findMany.mockResolvedValue(mockTransactions as any)
  ...
  it('should filter by memberId', async () => {
    ...
    dbMock.creditTransaction.count.mockResolvedValue(1)
    dbMock.creditTransaction.findMany.mockResolvedValue([mockTransactions[0]] as any)
    ...
    expect(dbMock.familyMember.findUnique).toHaveBeenCalledWith({
      where: { id: 'child-1' },
  ...
  it('should filter by category', async () => {
    dbMock.creditTransaction.findMany.mockResolvedValue([mockTransactions[1]] as any)
  ...
  it('should support pagination', async () => {
    dbMock.creditTransaction.findMany.mockResolvedValue(mockTransactions as any)
    dbMock.creditTransaction.count.mockResolvedValue(50)
  ...
  it('should allow parents to view any family member transactions', async () => {
    ...
    dbMock.creditTransaction.count.mockResolvedValue(2)
    dbMock.creditTransaction.findMany.mockResolvedValue(mockTransactions as any)
