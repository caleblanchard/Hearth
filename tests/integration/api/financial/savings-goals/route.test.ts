...
describe('/api/financial/savings-goals', () => {
  ...
  describe('GET', () => {
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.savingsGoal.findMany.mockRejectedValue(new Error('Database error'))
  ...
  describe('POST', () => {
    ...
    it('should create goal for child (using own ID)', async () => {
      ...
      dbMock.savingsGoal.create.mockResolvedValue(mockGoal as any)
      ...
      expect(dbMock.savingsGoal.create).toHaveBeenCalledWith({
        data: {
          memberId: session.user.id,
          name: 'New Bike',
          description: 'Save for a new bike',
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.savingsGoal.create.mockRejectedValue(new Error('Database error'))
