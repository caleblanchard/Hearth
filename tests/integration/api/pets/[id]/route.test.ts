...
describe('/api/pets/[id]', () => {
  ...
  describe('GET /api/pets/[id]', () => {
    ...
    it('should return pet by id', async () => {
      ...
      expect(dbMock.pet.findUnique).toHaveBeenCalledWith({
        where: { id: 'pet-1' },
      });
    });
  ...
  describe('PATCH /api/pets/[id]', () => {
    ...
    it('should update pet basic fields', async () => {
      ...
      dbMock.pet.update.mockResolvedValue(updatedPet as any);
      ...
      expect(dbMock.pet.update).toHaveBeenCalledWith({
        where: { id: 'pet-1' },
        data: {
          name: 'Maximus',
          notes: 'Updated notes',
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.pet.findUnique.mockResolvedValue(mockPet as any);
      dbMock.pet.update.mockRejectedValue(new Error('Database error'));
  ...
  describe('DELETE /api/pets/[id]', () => {
    ...
    it('should delete pet successfully', async () => {
      dbMock.pet.findUnique.mockResolvedValue(mockPet as any);
      dbMock.pet.delete.mockResolvedValue(mockPet as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
      ...
      expect(dbMock.pet.delete).toHaveBeenCalledWith({
        where: { id: 'pet-1' },
      });
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.pet.findUnique.mockResolvedValue(mockPet as any);
      dbMock.pet.delete.mockRejectedValue(new Error('Database error'));
