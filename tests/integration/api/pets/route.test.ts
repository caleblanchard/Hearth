...
describe('/api/pets', () => {
  ...
  describe('GET /api/pets', () => {
    ...
    it('should return all pets for family', async () => {
      ...
      dbMock.pet.findMany.mockResolvedValue(mockPetsWithFeedings as any);
      ...
      expect(dbMock.pet.findMany).toHaveBeenCalledWith({
        where: {
          familyId: 'family-test-123',
        },
        orderBy: {
    ...
    it('should return empty array when no pets exist', async () => {
      dbMock.pet.findMany.mockResolvedValue([]);
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.pet.findMany.mockRejectedValue(new Error('Database error'));
  ...
  describe('POST /api/pets', () => {
    ...
    it('should create pet with minimal data', async () => {
      ...
      dbMock.pet.create.mockResolvedValue(mockPet as any);
      ...
      expect(dbMock.pet.create).toHaveBeenCalledWith({
        data: {
          familyId: 'family-test-123',
          name: 'Max',
          species: 'DOG',
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.pet.create.mockRejectedValue(new Error('Database error'));
