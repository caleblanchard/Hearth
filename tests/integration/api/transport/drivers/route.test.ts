...
describe('/api/transport/drivers', () => {
  ...
  describe('GET', () => {
    ...
    it('should return all drivers for family', async () => {
      dbMock.transportDriver.findMany.mockResolvedValue([mockDriver] as any);
  ...
  describe('POST', () => {
    ...
    it('should create driver successfully', async () => {
      dbMock.transportDriver.create.mockResolvedValue(mockDriver as any);
      ...
      expect(dbMock.transportDriver.create).toHaveBeenCalledWith({
        data: {
          familyId: 'family-test-123',
          name: 'Mom',
          phone: '555-1234',
