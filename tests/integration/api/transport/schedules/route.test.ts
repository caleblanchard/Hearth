...
describe('/api/transport/schedules', () => {
  ...
  describe('GET /api/transport/schedules', () => {
    ...
    it('should return all schedules for family', async () => {
      dbMock.transportSchedule.findMany.mockResolvedValue([mockSchedule] as any);
  ...
  describe('POST /api/transport/schedules', () => {
    ...
    it('should create transport schedule successfully', async () => {
      ...
      dbMock.transportSchedule.create.mockResolvedValue(mockSchedule as any);
      ...
      expect(dbMock.transportSchedule.create).toHaveBeenCalledWith({
        data: {
          familyId: 'family-test-123',
          memberId: 'child-test-123',
          dayOfWeek: 1,
    ...
    it('should create schedule with carpool', async () => {
      ...
      dbMock.transportSchedule.create.mockResolvedValue(scheduleWithCarpool as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
