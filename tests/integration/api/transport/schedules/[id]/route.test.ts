...
describe('/api/transport/schedules/[id]', () => {
  ...
  describe('GET /api/transport/schedules/[id]', () => {
    ...
    it('should return 404 if schedule not found', async () => {
      dbMock.transportSchedule.findUnique.mockResolvedValue(null);
    ...
    it('should return 403 if schedule belongs to different family', async () => {
      dbMock.transportSchedule.findUnique.mockResolvedValue({
        ...mockSchedule,
    ...
    it('should return schedule successfully', async () => {
      dbMock.transportSchedule.findUnique.mockResolvedValue(mockSchedule as any);
  ...
  describe('PATCH /api/transport/schedules/[id]', () => {
    ...
    it('should update schedule successfully', async () => {
      ...
      dbMock.transportSchedule.update.mockResolvedValue(updatedSchedule as any);
  ...
  describe('DELETE /api/transport/schedules/[id]', () => {
    ...
    it('should delete schedule successfully (soft delete)', async () => {
      dbMock.transportSchedule.findUnique.mockResolvedValue(mockSchedule as any);
      dbMock.transportSchedule.update.mockResolvedValue({
        ...mockSchedule,
        isActive: false,
      } as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
      ...
      expect(dbMock.transportSchedule.update).toHaveBeenCalledWith({
        where: { id: 'schedule-1' },
        data: { isActive: false },
      });
