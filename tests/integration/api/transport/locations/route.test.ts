...
describe('/api/transport/locations', () => {
  ...
  describe('GET', () => {
    ...
    it('should return all locations for family', async () => {
      dbMock.transportLocation.findMany.mockResolvedValue([mockLocation] as any);
  ...
  describe('POST', () => {
    ...
    it('should create location successfully', async () => {
      dbMock.transportLocation.create.mockResolvedValue(mockLocation as any);
      ...
      expect(dbMock.transportLocation.create).toHaveBeenCalledWith({
        data: {
          familyId: 'family-test-123',
          name: 'Elementary School',
          address: '123 School St',
