...
describe('DELETE /api/meals/plan/[id]', () => {
  ...
  it('should return 404 if meal entry not found', async () => {
    ...
    dbMock.mealPlanEntry.findUnique.mockResolvedValue(null);
  ...
  it('should return 403 if entry belongs to different family', async () => {
    ...
    dbMock.mealPlanEntry.findUnique.mockResolvedValue(existingEntry as any);
  ...
  it('should delete meal entry successfully', async () => {
    ...
    dbMock.mealPlanEntry.findUnique.mockResolvedValue(existingEntry as any);
    dbMock.mealPlanEntry.delete.mockResolvedValue(existingEntry as any);
    ...
    expect(dbMock.mealPlanEntry.delete).toHaveBeenCalledWith({
      where: { id: 'entry-123' },
    });
  });
...
describe('PATCH /api/meals/plan/[id]', () => {
  ...
  it('should update meal entry successfully', async () => {
    ...
    dbMock.mealPlanEntry.findUnique.mockResolvedValue(existingEntry as any);
    dbMock.mealPlanEntry.update.mockResolvedValue(updatedEntry as any);
    dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  it('should create audit log on update', async () => {
    ...
    dbMock.mealPlanEntry.findUnique.mockResolvedValue(existingEntry as any);
    dbMock.mealPlanEntry.update.mockResolvedValue(existingEntry as any);
    dbMock.auditLog.create.mockResolvedValue({} as any);
