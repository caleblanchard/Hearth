...
describe('/api/meals/recipes/[id]/rate', () => {
  ...
  describe.skip('DELETE /api/meals/recipes/[id]/rate', () => {
    ...
    it('should delete rating successfully', async () => {
      dbMock.recipe.findUnique.mockResolvedValue(mockRecipe as any);
      dbMock.recipeRating.delete.mockResolvedValue(mockRating as any);
      ...
      expect(dbMock.recipeRating.delete).toHaveBeenCalledWith({
        where: {
          recipeId_memberId: {
            recipeId: 'recipe-1',
            memberId: 'parent-test-123',
    ...
    it('should return 404 if rating does not exist', async () => {
      dbMock.recipe.findUnique.mockResolvedValue(mockRecipe as any);
      dbMock.recipeRating.delete.mockRejectedValue({ code: 'P2025' });
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.recipe.findUnique.mockResolvedValue(mockRecipe as any);
      dbMock.recipeRating.delete.mockRejectedValue(new Error('Database error'));
