...
describe('/api/maintenance/[id]/complete', () => {
  ...
  it('should log completion with minimal data', async () => {
    ...
    dbMock.maintenanceCompletion.create.mockResolvedValue(mockCompletion as any);
    ...
    expect(dbMock.maintenanceCompletion.create).toHaveBeenCalledWith({
      data: {
        maintenanceItemId: 'item-1',
        completedBy: 'parent-test-123',
        completedAt: now,
  ...
  it('should allow children to log completions', async () => {
    ...
    dbMock.maintenanceCompletion.create.mockResolvedValue(mockCompletion as any);
    dbMock.maintenanceItem.update.mockResolvedValue(mockMaintenanceItem as any);
    dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  it('should handle database errors gracefully', async () => {
    dbMock.maintenanceItem.findUnique.mockResolvedValue(mockMaintenanceItem as any);
    dbMock.maintenanceCompletion.create.mockRejectedValue(new Error('Database error'));
