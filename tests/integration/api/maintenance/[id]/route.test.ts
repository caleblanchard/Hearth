...
describe('/api/maintenance/[id]', () => {
  ...
  describe('GET /api/maintenance/[id]', () => {
    ...
    it('should return 404 if item not found', async () => {
      dbMock.maintenanceItem.findUnique.mockResolvedValue(null);
    ...
    it('should return 403 if item belongs to different family', async () => {
      ...
      dbMock.maintenanceItem.findUnique.mockResolvedValue(otherFamilyItem as any);
    ...
    it('should allow children to view maintenance items', async () => {
      dbMock.maintenanceItem.findUnique.mockResolvedValue({
        ...mockMaintenanceItem,
        completions: [],
      } as any);
  ...
  describe('PATCH /api/maintenance/[id]', () => {
    ...
    it('should update maintenance item fields', async () => {
      ...
      dbMock.maintenanceItem.update.mockResolvedValue(updatedItem as any);
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.maintenanceItem.findUnique.mockResolvedValue(mockMaintenanceItem as any);
      dbMock.maintenanceItem.update.mockRejectedValue(new Error('Database error'));
  ...
  describe('DELETE /api/maintenance/[id]', () => {
    ...
    it('should delete maintenance item successfully', async () => {
      dbMock.maintenanceItem.findUnique.mockResolvedValue(mockMaintenanceItem as any);
      dbMock.maintenanceItem.delete.mockResolvedValue(mockMaintenanceItem as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
      ...
      expect(dbMock.maintenanceItem.delete).toHaveBeenCalledWith({
        where: { id: 'item-1' },
      });
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.maintenanceItem.findUnique.mockResolvedValue(mockMaintenanceItem as any);
      dbMock.maintenanceItem.delete.mockRejectedValue(new Error('Database error'));
