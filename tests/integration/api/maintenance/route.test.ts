...
describe('/api/maintenance', () => {
  ...
  describe('GET /api/maintenance', () => {
    ...
    it('should return all maintenance items for family', async () => {
      ...
      dbMock.maintenanceItem.findMany.mockResolvedValue(mockItems as any);
    ...
    it('should allow children to view maintenance items', async () => {
      dbMock.maintenanceItem.findMany.mockResolvedValue([mockMaintenanceItem] as any);
  ...
  describe('POST /api/maintenance', () => {
    ...
    it('should create maintenance item with minimal data', async () => {
      ...
      dbMock.maintenanceItem.create.mockResolvedValue(minimalItem as any);
      ...
      expect(dbMock.maintenanceItem.create).toHaveBeenCalledWith({
        data: {
          familyId: 'family-test-123',
          name: 'HVAC Filter Replacement',
          description: null,
    ...
    it('should create maintenance item with full data', async () => {
      ...
      dbMock.maintenanceItem.create.mockResolvedValue(fullItem as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.maintenanceItem.create.mockRejectedValue(new Error('Database error'));
