...
describe('GET /api/projects/tasks/[taskId]', () => {
  ...
  describe('Error Handling', () => {
    it('should return 500 if database query fails', async () => {
      dbMock.projectTask.findUnique.mockRejectedValue(new Error('Database error'));
...
describe('PATCH /api/projects/tasks/[taskId]', () => {
  ...
  describe('Task Updates', () => {
    ...
    it('should update task name', async () => {
      ...
      dbMock.projectTask.findUnique.mockResolvedValue(mockTask as any);
      dbMock.projectTask.update.mockResolvedValue(updatedTask as any);
    ...
    it('should trim whitespace from name', async () => {
      ...
      dbMock.projectTask.findUnique.mockResolvedValue(mockTask as any);
      dbMock.projectTask.update.mockResolvedValue({} as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
      ...
      await PATCH(request, { params: Promise.resolve({ taskId: 'task-1' }) });

      expect(dbMock.projectTask.update).toHaveBeenCalledWith(
  ...
  describe('Audit Logging', () => {
    it('should create an audit log entry on successful update', async () => {
      ...
      dbMock.projectTask.findUnique.mockResolvedValue(mockTask as any);
      dbMock.projectTask.update.mockResolvedValue(mockTask as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  describe('Error Handling', () => {
    it('should return 500 if database operation fails', async () => {
      ...
      dbMock.projectTask.findUnique.mockResolvedValue(mockTask as any);
      dbMock.projectTask.update.mockRejectedValue(new Error('Database error'));
...
describe('DELETE /api/projects/tasks/[taskId]', () => {
  ...
  describe('Task Deletion', () => {
    ...
    it('should delete task successfully', async () => {
      ...
      dbMock.projectTask.findUnique.mockResolvedValue(mockTask as any);
      dbMock.projectTask.delete.mockResolvedValue(mockTask as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
      ...
      expect(dbMock.projectTask.delete).toHaveBeenCalledWith({
        where: { id: 'task-1' },
      });
    });
  });
  ...
  describe('Audit Logging', () => {
    it('should create an audit log entry on successful deletion', async () => {
      ...
      await DELETE(request, { params: Promise.resolve({ taskId: 'task-1' }) });
  ...
  describe('Error Handling', () => {
    it('should return 500 if database operation fails', async () => {
      ...
      dbMock.projectTask.findUnique.mockResolvedValue(mockTask as any);
      dbMock.projectTask.delete.mockRejectedValue(new Error('Database error'));
