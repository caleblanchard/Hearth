...
describe('GET /api/projects/[id]', () => {
  ...
  describe('Error Handling', () => {
    it('should return 500 if database query fails', async () => {
      dbMock.project.findUnique.mockRejectedValue(new Error('Database error'));
...
describe('PATCH /api/projects/[id]', () => {
  ...
  describe('Project Update', () => {
    it('should update project with partial data', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.project.update.mockResolvedValue(updatedProject as any);
    ...
    it('should update all fields', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.project.update.mockResolvedValue({} as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  describe('Audit Logging', () => {
    it('should create audit log on successful update', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.project.update.mockResolvedValue(mockProject as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  describe('Error Handling', () => {
    it('should return 500 if database update fails', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.project.update.mockRejectedValue(new Error('Database error'));
...
describe('DELETE /api/projects/[id]', () => {
  ...
  describe('Project Deletion', () => {
    it('should delete project successfully', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.project.delete.mockResolvedValue(mockProject as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  describe('Error Handling', () => {
    it('should return 500 if database deletion fails', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.project.delete.mockRejectedValue(new Error('Database error'));
