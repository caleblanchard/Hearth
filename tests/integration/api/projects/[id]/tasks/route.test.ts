...
describe('GET /api/projects/[id]/tasks', () => {
  ...
  describe('Task Listing', () => {
    it('should return all tasks for a project', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.projectTask.findMany.mockResolvedValue(mockTasks as any);
  ...
  describe('Error Handling', () => {
    it('should return 500 if database query fails', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.projectTask.findMany.mockRejectedValue(new Error('Database error'));
...
describe('POST /api/projects/[id]/tasks', () => {
  ...
  describe('Task Creation', () => {
    it('should create a task with minimal data', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.projectTask.count.mockResolvedValue(0);
      dbMock.projectTask.create.mockResolvedValue(mockTask as any);
    ...
    it('should create a task with all fields', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.projectTask.count.mockResolvedValue(2);
      ...
      expect(response.status).toBe(201);
      expect(dbMock.projectTask.create).toHaveBeenCalledWith({
        data: {
          projectId: 'project-1',
          name: 'Book venue',
          description: 'Find and book party venue',
    ...
    it('should auto-increment sortOrder', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.projectTask.count.mockResolvedValue(5);
      dbMock.projectTask.create.mockResolvedValue({} as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
  ...
  describe('Error Handling', () => {
    it('should return 500 if database operation fails', async () => {
      ...
      dbMock.project.findUnique.mockResolvedValue(mockProject as any);
      dbMock.projectTask.count.mockResolvedValue(0);
      dbMock.projectTask.create.mockRejectedValue(new Error('Database error'));
