...
describe('/api/documents/expiring', () => {
  ...
  describe('GET', () => {
    ...
    it('should return documents expiring within default 90 days', async () => {
      ...
      dbMock.document.findMany.mockResolvedValue(mockExpiringDocuments as any);
      ...
      const callArgs = (dbMock.document.findMany as jest.Mock).mock.calls[0][0];
    ...
    it('should order documents by expiration date ascending', async () => {
      ...
      dbMock.document.findMany.mockResolvedValue(mockDocuments as any);
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.document.findMany.mockRejectedValue(new Error('Database error'));
