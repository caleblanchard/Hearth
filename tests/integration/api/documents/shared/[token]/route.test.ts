...
describe('/api/documents/shared/[token]', () => {
  ...
  describe('GET', () => {
    ...
    it('should return 410 if share link is expired', async () => {
      ...
      dbMock.documentShareLink.findUnique.mockResolvedValue(expiredShareLink as any);
    ...
    it('should return 410 if share link is revoked', async () => {
      ...
      dbMock.documentShareLink.findUnique.mockResolvedValue(revokedShareLink as any);
    ...
    it('should return document and increment access count', async () => {
      ...
      dbMock.documentShareLink.update.mockResolvedValue({} as any);
      dbMock.documentAccessLog.create.mockResolvedValue({} as any);
      ...
      expect(dbMock.documentAccessLog.create).toHaveBeenCalledWith({
        data: {
          documentId: 'doc-1',
