...
describe('/api/todos/[id]', () => {
  ...
  describe('PATCH', () => {
    ...
    it('should return 404 if todo not found', async () => {
      ...
      dbMock.todoItem.findUnique.mockResolvedValue(null)
    ...
    it('should return 403 if todo belongs to different family', async () => {
      ...
      dbMock.todoItem.findUnique.mockResolvedValue({
        ...mockTodo,
    ...
    it('should update todo successfully', async () => {
      ...
      dbMock.todoItem.update.mockResolvedValue(mockUpdatedTodo as any)
      ...
      expect(dbMock.todoItem.update).toHaveBeenCalledWith({
        where: { id: todoId },
        data: {
          title: 'Updated Todo',
          status: TodoStatus.COMPLETED,
    ...
    it('should set completedAt when status is COMPLETED', async () => {
      ...
      dbMock.todoItem.update.mockResolvedValue({
        ...mockTodo,
        status: TodoStatus.COMPLETED,
        completedAt: new Date(),
      } as any)
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.todoItem.findUnique.mockResolvedValue(mockTodoWithFamily as any)
      dbMock.todoItem.update.mockRejectedValue(new Error('Database error'))
  ...
  describe('DELETE', () => {
    ...
    it('should delete todo successfully', async () => {
      ...
      dbMock.todoItem.delete.mockResolvedValue(mockTodo as any)
      ...
      expect(dbMock.todoItem.delete).toHaveBeenCalledWith({
        where: { id: todoId },
      })
    })
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.todoItem.delete.mockRejectedValue(new Error('Database error'))
