...
describe('/api/todos', () => {
  ...
  describe('GET', () => {
    ...
    it('should return active todos by default', async () => {
      ...
      dbMock.todoItem.count.mockResolvedValue(mockTodos.length)
      ...
      expect(dbMock.todoItem.findMany).toHaveBeenCalled()
      expect(dbMock.todoItem.count).toHaveBeenCalled()
    })
    ...
    it('should filter by completed todos', async () => {
      ...
      dbMock.todoItem.count.mockResolvedValue(0)
  ...
  describe('POST', () => {
    ...
    it('should create todo successfully', async () => {
      ...
      dbMock.todoItem.create.mockResolvedValue(mockCreatedTodo as any)
      ...
      expect(dbMock.todoItem.create).toHaveBeenCalledWith({
        data: {
          familyId: session.user.familyId,
          title: 'New Todo',
          description: 'Test description',
