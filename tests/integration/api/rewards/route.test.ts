...
describe('/api/rewards', () => {
  ...
  describe('GET', () => {
    ...
    it('should return active rewards for authenticated user', async () => {
      ...
      dbMock.rewardItem.findMany.mockResolvedValue(mockRewards as any)
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.rewardItem.findMany.mockRejectedValue(new Error('Database error'))
  ...
  describe('POST', () => {
    ...
    it('should create reward successfully', async () => {
      ...
      dbMock.rewardItem.create.mockResolvedValue(mockReward as any)
      ...
      expect(dbMock.rewardItem.create).toHaveBeenCalledWith({
        data: {
          familyId: session.user.familyId,
          name: 'New Reward',
          description: 'A new reward',
    ...
    it('should return 500 on error', async () => {
      ...
      dbMock.rewardItem.create.mockRejectedValue(new Error('Database error'))
