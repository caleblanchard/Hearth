...
describe('/api/approvals', () => {
  ...
  describe('GET /api/approvals - Unified Queue', () => {
    ...
    it('should return empty array if no pending approvals', async () => {
      ...
      dbMock.choreInstance.findMany.mockResolvedValueOnce([]);
      dbMock.rewardRedemption.findMany.mockResolvedValueOnce([]);
      dbMock.shoppingItem.findMany.mockResolvedValueOnce([]);
    ...
    it('should return pending chore completions', async () => {
      ...
      dbMock.choreInstance.findMany.mockResolvedValueOnce([mockChore] as any);
      dbMock.rewardRedemption.findMany.mockResolvedValueOnce([]);
      dbMock.shoppingItem.findMany.mockResolvedValueOnce([]);
    ...
    it('should return pending reward redemptions', async () => {
      ...
      dbMock.choreInstance.findMany.mockResolvedValueOnce([]);
      dbMock.rewardRedemption.findMany.mockResolvedValueOnce([mockRedemption] as any);
      dbMock.shoppingItem.findMany.mockResolvedValueOnce([]);
    ...
    it('should filter approvals from other families', async () => {
      ...
      dbMock.choreInstance.findMany.mockResolvedValueOnce([mockChoreOwnFamily, mockChoreOtherFamily] as any);
      dbMock.rewardRedemption.findMany.mockResolvedValueOnce([]);
      dbMock.shoppingItem.findMany.mockResolvedValueOnce([]);
