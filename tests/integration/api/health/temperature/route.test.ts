...
describe('/api/health/temperature', () => {
  ...
  describe('POST', () => {
    ...
    it('should allow parents to log temperature for any family member', async () => {
      ...
      dbMock.temperatureLog.create.mockResolvedValue(mockTempLog as any);
      ...
      expect(dbMock.temperatureLog.create).toHaveBeenCalledWith({
        data: {
          memberId: 'child-test-123',
          temperature: 101.5,
          method: 'ORAL',
    ...
    it('should allow children to log their own temperature', async () => {
      ...
      dbMock.temperatureLog.create.mockResolvedValue({
        ...mockTempLog,
        temperature: 98.6,
      } as any);
    ...
    describe('Sick Mode Auto-Trigger', () => {
      ...
      dbMock.healthEvent.findFirst.mockResolvedValue(null);
      dbMock.healthEvent.create.mockResolvedValue({
        id: 'health-event-1',
        memberId: 'child-test-123',
        eventType: 'ILLNESS',
      } as any);
      dbMock.sickModeInstance.create.mockResolvedValue({
        id: 'sick-mode-1',
        memberId: 'child-test-123',
      ...
      expect(dbMock.sickModeInstance.create).toHaveBeenCalled();
    });
    ...
    it('should not auto-trigger if temperature is below threshold', async () => {
      ...
      expect(dbMock.sickModeInstance.create).not.toHaveBeenCalled();
    });
