...
describe('/api/medications', () => {
  ...
  describe('GET', () => {
    ...
    it('should return all medications for family', async () => {
      dbMock.medicationSafety.findMany.mockResolvedValue([mockMedication] as any);
      ...
      expect(dbMock.medicationSafety.findMany).toHaveBeenCalledWith({
        where: {
          member: {
            familyId: 'family-test-123',
          },
    ...
    it('should handle database errors gracefully', async () => {
      dbMock.medicationSafety.findMany.mockRejectedValue(new Error('Database error'));
  ...
  describe('POST', () => {
    ...
    it('should create medication successfully', async () => {
      ...
      dbMock.medicationSafety.create.mockResolvedValue(newMedication as any);
      ...
      expect(dbMock.medicationSafety.create).toHaveBeenCalledWith({
        data: {
          memberId: 'child-test-123',
          medicationName: 'Children\'s Tylenol',
          activeIngredient: 'Acetaminophen',
    ...
    it('should handle optional fields correctly', async () => {
      ...
      dbMock.medicationSafety.create.mockResolvedValue(minimalMedication as any);
      dbMock.auditLog.create.mockResolvedValue({} as any);
