...
export const apiRateLimiter = new RateLimiter(60000, 300); // 300 requests per minute
export const authRateLimiter = new RateLimiter(60000, 10); // 10 requests per minute for auth (signin/signout)
